...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(module) {/* harmony import */ var _root__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./root */ "./src/root.js");
/* harmony import */ var _root__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_root__WEBPACK_IMPORTED_MODULE_0__);
...
module.exports = _root__WEBPACK_IMPORTED_MODULE_0___default.a;
...
_root__WEBPACK_IMPORTED_MODULE_1___default.a.Soundfont = {};
_root__WEBPACK_IMPORTED_MODULE_1___default.a.DEBUG = true;
_root__WEBPACK_IMPORTED_MODULE_1___default.a.USE_XHR = true;
_root__WEBPACK_IMPORTED_MODULE_1___default.a.soundfontUrl = './soundfont/';
/*
  root.loadPlugin({
    onsuccess: function() { },
...
_root__WEBPACK_IMPORTED_MODULE_1___default.a.loadPlugin = function (opts) {
  ...
  _root__WEBPACK_IMPORTED_MODULE_1___default.a.soundfontUrl = opts.soundfontUrl || _root__WEBPACK_IMPORTED_MODULE_1___default.a.soundfontUrl; // / Detect the best type of audio to use

  Object(_utils__WEBPACK_IMPORTED_MODULE_0__["audioDetect"])(function (supports) {
    ...
    if (connect[api]) {
      ...
      _root__WEBPACK_IMPORTED_MODULE_1___default.a.__api = api;
      _root__WEBPACK_IMPORTED_MODULE_1___default.a.__audioFormat = audioFormat;
      _root__WEBPACK_IMPORTED_MODULE_1___default.a.supports = supports;
      _root__WEBPACK_IMPORTED_MODULE_1___default.a.loadResource(opts);
    }
  });
};
/*
...
_root__WEBPACK_IMPORTED_MODULE_1___default.a.loadResource = function (opts) {
  ...
  for (var i = 0; i < instruments.length; i++) {
    ...
    if (instrument === +instrument) {
      // is numeric
      if (_root__WEBPACK_IMPORTED_MODULE_1___default.a.GM.byId[instrument]) {
        instruments[i] = _root__WEBPACK_IMPORTED_MODULE_1___default.a.GM.byId[instrument].id;
      }
    }
  } // /


  opts.format = _root__WEBPACK_IMPORTED_MODULE_1___default.a.__audioFormat;
  opts.instruments = instruments; // /

  connect[_root__WEBPACK_IMPORTED_MODULE_1___default.a.__api](opts);
};

var connect = {
  webmidi: function webmidi(opts) {
    // cant wait for this to be standardized!
    _root__WEBPACK_IMPORTED_MODULE_1___default.a.WebMIDI.connect(opts);
  },
...
var requestQueue = function requestQueue(opts, context) {
  ...
  var waitForEnd = function waitForEnd() {
    if (! --pending) {
      ...
      _root__WEBPACK_IMPORTED_MODULE_1___default.a[context].connect(opts);
    }
  }; // /
  ...
  for (var i = 0; i < length; i++) {
    ...
    if (_root__WEBPACK_IMPORTED_MODULE_1___default.a.Soundfont[instrumentId]) {
      // already loaded
      waitForEnd();
    } else {
...
var sendRequest = function sendRequest(instrumentId, audioFormat, onprogress, _onsuccess, onerror) {
  var soundfontPath = _root__WEBPACK_IMPORTED_MODULE_1___default.a.soundfontUrl + instrumentId + '-' + audioFormat + '.js';

  if (_root__WEBPACK_IMPORTED_MODULE_1___default.a.USE_XHR) {
    Object(_utils__WEBPACK_IMPORTED_MODULE_0__["request"])({
      url: soundfontPath,
      format: 'text',
      onerror: onerror,
    ...
    _utils__WEBPACK_IMPORTED_MODULE_0__["loadScript"].add({
      url: soundfontPath,
...
_root__WEBPACK_IMPORTED_MODULE_1___default.a.setDefaultPlugin = function (midi) {
  for (var key in midi) {
    _root__WEBPACK_IMPORTED_MODULE_1___default.a[key] = midi[key];
  }
};
...
window.Audio && function () {
  ...
  midi.noteOff = function (channel, note, delay) {//      var id = noteToKey[note]
    //      if (!notes[id]) return
    //      if (delay) {
    //        return setTimeout(function() {
